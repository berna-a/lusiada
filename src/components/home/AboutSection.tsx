  ...
  return (
    <section className="py-14 md:py-20 bg-card relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-3xl text-center space-y-6">
        <blockquote className="text-xl sm:text-2xl md:text-3xl font-semibold text-foreground italic leading-snug font-display border-l-2 border-accent pl-4 sm:pl-8 text-left">
          "Uma nação que não conhece a sua história está condenada a perdê-la."
        </blockquote>
        <p className="text-muted-foreground text-sm md:text-base leading-relaxed text-left pl-4 sm:pl-8 font-body">

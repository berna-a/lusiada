...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-end overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_80%_-10%,hsl(var(--electric)/0.08),transparent)]" />

      {/* Bottom vignette */}
      <div className="absolute bottom-0 inset-x-0 h-64 bg-gradient-to-t from-background/20 to-transparent" />
      ...
      <div className="relative z-10 container mx-auto px-4 pb-20 pt-36 md:pb-28 md:pt-44">
        <div className="max-w-2xl space-y-7">
          ...
          <p className="text-base md:text-lg text-primary-foreground/60 max-w-md leading-relaxed font-body font-light">

...
export const EPISODES: Episode[] = [
  { key: "partida", x: 168, y: 118, side: "r", lugar: "Lisboa", episodio: "A partida — Despedida do Restelo", canto: 4 },
  { key: "cabo", x: 300, y: 470, side: "r", lugar: "Cabo da Boa Esperança", episodio: "O Gigante Adamastor", canto: 5 },
  { key: "mocambique", x: 428, y: 408, side: "l", lugar: "Moçambique", episodio: "Primeiro contacto", canto: 1 },
  { key: "mombaca", x: 460, y: 356, side: "l", lugar: "Mombaça", episodio: "A cilada dos mouros", canto: 2 },
  { key: "melinde", x: 502, y: 300, side: "l", lugar: "Melinde", episodio: "Gama narra a história de Portugal", canto: 3 },
  { key: "calecute", x: 726, y: 222, side: "l", lugar: "Calecute, Índia", episodio: "A chegada e o Samorim", canto: 7 },
  { key: "amores", x: 636, y: 330, side: "r", lugar: "Ilha dos Amores", episodio: "O prémio dos heróis", canto: 9 },
];
...
const LAND = {
  iberia: "M120,78 Q170,58 224,86 Q240,128 196,156 Q142,168 116,134 Q104,100 120,78 Z",
  africa:
...
export function MapaDaViagem({ base }: { base: string }) {
  ...
  return (
    ...
    >
      ...
      <rect fill="hsl(40 40% 94%)" height="540" rx="16" width="820" x="0" y="0" />
      ...
      <g transform="translate(620,120)">
        ...
        <text fill="hsl(28 40% 45%)" fontSize="10" textAnchor="middle" x="0" y="-32">
          N
        </text>
      </g>
    </svg>
